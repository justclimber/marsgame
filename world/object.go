...
func NewObject(id uint32, typeObj string, p physics.Point, colRadius int16, angle, speed, rotation, weight float64) Object {
...
func (o *Object) getCollisionRadius() int16 { return o.CollisionRadius }
